...
import com.huertohogar.huertohogarmovil.screens.admin.AdminRoute
            ...
            AdminRoute(
                    onNavigateBack = {
                        navController.navigate(Graph.AUTHENTICATION) {
                            popUpTo("admin_screen") { inclusive = true }
                        }
                    }
            )
        }
...
fun MainNavigationGraph(
    ...
    NavHost(
        ...
        composable(MainScreen.Home.route) { HomeRoute(onNavigateToProductDetails = { /* ... */}) }
        composable(MainScreen.Products.route) {
            ProductsRoute(onNavigateToProductDetails = { /* ... */})
        }
        ...
        composable(route = mapRoute) { MapRoute(onNavigateBack = { navController.popBackStack() }) }
    }
}
